...
* The definition of a valid OSCD file (written in the XText file Oscf.Xtext) declaratively defines the compliance knowledge.
* The corresponding Open Source Compliance File (im Markdown format) is derived from the OSCD file by the OscfGenerator.xtend.
