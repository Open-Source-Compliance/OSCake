# Open Source Compliance File for the package tc03-gen 
## 0.) About this file:

Based on the data container `/home/karsten/data/tdosca-tc03.zip` (type: "ZIP"), the
Open Source Compliance Artifacts of and for the program collection **tc03-gen**
have been gathered into the file `tc03-gen.oscf.md` which
