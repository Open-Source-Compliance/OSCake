...
* Contributions must be licensed under the [Eclipse Public License 2.0](LICENSE) (= EPL-2.0)
...
* Contributions should be licensed under the same license as code (= [EPL-2.0](LICENSE)) otherwise under the creative commons license [CC-BY-SA-4.0](doc/LICENSE) or - if that does not fit the intended purposes - under the creative commons license [CC-BY-4.0](doc/LICENSE.fallback)
