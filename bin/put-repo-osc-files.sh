...
cp ${OSCC_REPODIR}/${OSCC_FILE} ${OSCC_DEVDIR}/${OSCC_FILE}
cp ${OSCC_REPODIR}/${OSCC_GEN_FILE} ${OSCC_DEVDIR}/generator/${OSCC_GEN_FILE}
cp ${OSCF_REPODIR}/${OSCF_FILE} ${OSCF_DEVDIR}/${OSCF_FILE}
cp ${OSCF_REPODIR}/${OSCF_GEN_FILE} ${OSCF_DEVDIR}/generator/${OSCF_GEN_FILE}
